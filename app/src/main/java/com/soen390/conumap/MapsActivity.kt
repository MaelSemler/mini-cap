...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //View transfer from bottom field to top field + Restart with back button
        val imgArrow = findViewById<ImageView>(R.id.imgArrow)
        val frameBottomField = findViewById<FrameLayout>(R.id.frame_bottomField)
        frameBottomField.isVisible= true
        imgArrow.setOnClickListener {
            val locationFragment = TopFieldFragment()
            ...
            transaction.replace(R.id.frame_container,locationFragment)
            transaction.addToBackStack(null)

            // Finishing the transition
            transaction.commit()
            frameBottomField. isVisible = false
        }
