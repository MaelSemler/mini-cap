...
import com.soen390.conumap.IndoorNavigation.helperSearch.SearchAPI
import com.soen390.conumap.IndoorNavigation.helperSearch.SearchRepository
...
class IndoorSearchViewModel (private val searchApi: SearchAPI,
    ...
    class Factory(private val assets: AssetManager, private val dispatcher: CoroutineDispatcher) :
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return IndoorSearchViewModel(SearchRepository(assets), dispatcher) as T
        }
    }
}
